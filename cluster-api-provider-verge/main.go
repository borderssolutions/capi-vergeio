...
import (
	...
	"github.com/mashalabbas/cluster-api-provider-verge/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8842586d.cluster.x-k8s.io",
	...
	if err = (&controllers.VergeMachineReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "VergeMachine")
		os.Exit(1)
	}
